...
class UserAccelerometerEvent {
  ...
  UserAccelerometerEvent(this.x, this.y, this.z, this.timestamp, this.accuracy);
  ...
  @override
  String toString() => '[UserAccelerometerEvent (x: $x, y: $y, z: $z, timestamp: $timestamp, accuracy: $accuracy)]';
}
